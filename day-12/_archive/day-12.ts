...
let exploreNeighbours = (r: number, c: number) => {
  ...
  if (rUp >= 0 && !visited[rUp][cUp]) {
    ...
    let elevationDiff =
      elevationAlphabet.indexOf(charUp) -
  ...
  if (cRight < numCols && !visited[rRight][cRight]) {
    ...
    let elevationDiff =
      elevationAlphabet.indexOf(charRight) -
      elevationAlphabet.indexOf(chars[r][c]);
    if (elevationDiff < 2) {
  ...
  if (rDown < numRows && !visited[rDown][cDown]) {
    ...
    let elevationDiff =
      elevationAlphabet.indexOf(charDown) -
      elevationAlphabet.indexOf(chars[r][c]);
    if (elevationDiff < 2) {
  ...
  if (cLeft >= 0 && !visited[rLeft][cLeft]) {
    ...
    let elevationDiff =
      elevationAlphabet.indexOf(charLeft) -
      elevationAlphabet.indexOf(chars[r][c]);
    if (elevationDiff < 2) {
